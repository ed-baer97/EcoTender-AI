...
**Описание проекта:** [docs/PROJECT_DESCRIPTION.md](docs/PROJECT_DESCRIPTION.md)
...
Подробнее: [docs/PROJECT_DESCRIPTION.md](docs/PROJECT_DESCRIPTION.md).
...
docs/                    # описание, архитектура, API
scripts/                 # smoke_check и утилиты
```

Полный разбор сервисов: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md).
...
Версии: [docs/STACK.md](docs/STACK.md). Зависимости Python — `packages/shared/pyproject.toml` и `requirements` сервисов; фронт — `apps/web/package.json`.

## Документация

| Документ | Содержание |
|----------|------------|
| [docs/PROJECT_DESCRIPTION.md](docs/PROJECT_DESCRIPTION.md) | Описание проекта |
| [docs/GOSZAKUP_PARSER.md](docs/GOSZAKUP_PARSER.md) | goszakup: OWS v3 или Playwright-stub |
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | Архитектура микросервисов |
...
| [docs/ML_RISK_ENGINE.md](docs/ML_RISK_ENGINE.md) | CatBoost + LLM |
